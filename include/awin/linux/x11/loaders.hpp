...
namespace awin
{
    namespace platform
    {
        namespace x11
        {
            ...
            typedef Window (*PFN_XCreateWindow)(Display *, Window, int, int, unsigned int, unsigned int, unsigned int,
            ...
            typedef int (*PFN_XGetWindowProperty)(Display *, XID, Atom, long, long, Bool, Atom, Atom *, int *,
            ...
            typedef void (*PFN_Xutf8SetWMProperties)(Display *, XID, const char *, const char *, char **, int,
            ...
            typedef Status (*PFN_XRRSetCrtcConfig)(Display *, XRRScreenResources *, RRCrtc, Time, int, int, RRMode,
                                                   Rotation, RROutput *, int);
