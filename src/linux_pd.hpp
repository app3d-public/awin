...
namespace awin
{
    ...
    namespace platform
    {
        ...
        struct LinuxWindowCaller
        {
            ...
            acul::ipoint32 (*get_cursor_position)(WindowData *);
            void (*set_cursor_position)(WindowData *, acul::ipoint32);
            void (*hide_cursor)(WindowData *);
            void (*show_cursor)(Window *, WindowData *);
            acul::ipoint32 (*get_window_position)(WindowData *);
            void (*set_window_position)(WindowData *, acul::ipoint32);
        ...
        struct LinuxPlatformCaller
        {
            ...
            acul::ipoint32 (*get_window_size)(const Window &);
