...
namespace awin::platform::wayland
{
    ...
    bool valid_wayland_client(ILoader *loader)
    {
        ...
        return wc.wl_display_flush && wc.wl_display_cancel_read && wc.wl_display_dispatch_pending &&
               ...
               wc.wl_display_get_fd && wc.wl_display_prepare_read && wc.wl_proxy_marshal && wc.wl_proxy_add_listener &&
               wc.wl_proxy_destroy && wc.wl_proxy_marshal_constructor && wc.wl_proxy_marshal_constructor_versioned &&
               wc.wl_proxy_get_user_data && wc.wl_proxy_set_user_data && wc.wl_proxy_get_tag && wc.wl_proxy_set_tag;
    }
    ...
    bool valid_xkb_common(ILoader *loader)
    {
        ...
        return xkb.xkb_context_new && xkb.xkb_context_unref && xkb.xkb_keymap_new_from_string && xkb.xkb_keymap_unref &&
               xkb.xkb_keymap_mod_get_index && xkb.xkb_keymap_key_repeats && xkb.xkb_keymap_key_get_syms_by_level &&
               xkb.xkb_state_new && xkb.xkb_state_unref && xkb.xkb_state_key_get_syms && xkb.xkb_state_update_mask &&
               xkb.xkb_state_key_get_layout && xkb.xkb_state_mod_index_is_active &&
               xkb.xkb_compose_table_new_from_locale && xkb.xkb_compose_table_unref && xkb.xkb_compose_state_new &&
               xkb.xkb_compose_state_unref && xkb.xkb_compose_state_feed && xkb.xkb_compose_state_get_status &&
    ...
    bool valid_libdecor(ILoader *loader)
    {
        ...
        return ld.libdecor_new && ld.libdecor_unref && ld.libdecor_get_fd && ld.libdecor_dispatch &&
               ...
               ld.libdecor_frame_set_title && ld.libdecor_frame_set_minimized && ld.libdecor_frame_set_fullscreen &&
               ld.libdecor_frame_unset_fullscreen && ld.libdecor_frame_map && ld.libdecor_frame_commit &&
               ld.libdecor_frame_set_min_content_size && ld.libdecor_frame_set_max_content_size &&
               ld.libdecor_frame_set_maximized && ld.libdecor_frame_unset_maximized &&
               ld.libdecor_frame_set_capabilities && ld.libdecor_frame_unset_capabilities &&
               ld.libdecor_frame_set_visibility && ld.libdecor_frame_get_xdg_toplevel &&
               ld.libdecor_configuration_get_content_size && ld.libdecor_configuration_get_window_state &&
               ld.libdecor_state_new && ld.libdecor_state_free;
    }
