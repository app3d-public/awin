...
{
    LIBDECOR_AWIN_STATE_NONE = 0,
    LIBDECOR_AWIN_STATE_ACTIVE = 1,
    LIBDECOR_AWIN_STATE_MAXIMIZED = 2,
    LIBDECOR_AWIN_STATE_FULLSCREEN = 4,
    LIBDECOR_AWIN_STATE_TILED_LEFT = 8,
    LIBDECOR_AWIN_STATE_TILED_RIGHT = 16,
    LIBDECOR_AWIN_STATE_TILED_TOP = 32,
    LIBDECOR_AWIN_STATE_TILED_BOTTOM = 64
};
